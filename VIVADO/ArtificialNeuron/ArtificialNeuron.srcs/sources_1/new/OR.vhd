...
signal data_in_array_a31 : WORD_ARRAY_type ((ninputs - 1) downto 0);  -- inputs of each Artificial Neuron
signal finished_a31 : STD_LOGIC := '0';  -- signals used for showing if the Artificial Neuron has finished/has to start the procedure
signal a31_output : STD_LOGIC_VECTOR (7 downto 0) := (others=>'0');   -- output of the Artificial Neuron
signal a31_sum_out : STD_LOGIC_VECTOR (7 downto 0) := (others=>'0');  -- LUT input of the Artificial Neuron
...
data_in_array_a31 <= (input_2, input_1, one);
...
process(a31_sum_out, a31_output)
begin
