...
#
# Generated by export_simulation on Wed Jan 16 18:37:19 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './ROM_a22.sh' script.

./ROM_a22.sh -reset_run
...
./ROM_a22.sh -noclean_files

For more information on the script, please type './ROM_a22.sh -help'.
