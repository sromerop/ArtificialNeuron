...
#
# Generated by export_simulation on Wed Jan 16 18:41:30 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './ROM_a31.sh' script.

./ROM_a31.sh -reset_run
...
./ROM_a31.sh -noclean_files

For more information on the script, please type './ROM_a31.sh -help'.
