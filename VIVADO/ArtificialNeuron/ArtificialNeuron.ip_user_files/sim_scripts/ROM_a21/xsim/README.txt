...
#
# Generated by export_simulation on Wed Jan 16 18:30:28 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './ROM_a21.sh' script.

./ROM_a21.sh -reset_run
...
./ROM_a21.sh -noclean_files

For more information on the script, please type './ROM_a21.sh -help'.
