...
HD_PWD='C:/Users/srome/Desktop/ETSIT/TFG/Pablo Ituero/FPGA y Vivado/ArtificialNeuron/ArtificialNeuron.runs/ROM_a31_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_a31.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_a31.tcl
