...
HD_PWD='C:/Users/srome/Desktop/ETSIT/TFG/Pablo Ituero/FPGA y Vivado/ArtificialNeuron/ArtificialNeuron.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Neural_Network.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Neural_Network.tcl -notrace
