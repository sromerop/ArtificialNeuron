...
HD_PWD='C:/Users/srome/Desktop/ETSIT/TFG/Pablo Ituero/FPGA y Vivado/ArtificialNeuron/ArtificialNeuron.runs/clk_50MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_50MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_50MHz.tcl
