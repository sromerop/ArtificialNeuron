...
create_clock -add -name sys_clk_pin -period 11.75 -waveform {0 5.875} [get_ports {clk}];
...
#set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { enable_LUT }]; #IO_0_14 Sch=led17_g
