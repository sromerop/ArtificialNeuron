...
HD_PWD='C:/Users/srome/Desktop/ETSIT/TFG/Pablo Ituero/FPGA y Vivado/SigmoidLUT/SigmoidLUT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT.tcl
