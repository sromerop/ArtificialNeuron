...
HD_PWD='C:/Users/srome/Desktop/ETSIT/TFG/Pablo Ituero/FPGA y Vivado/SigmoidLUT/SigmoidLUT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LUT.tcl -notrace
